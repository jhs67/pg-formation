					...
					indices: {
						...
						elements: {
							...
							members: {
								...
								columns: { type: "array", elements: {
									type: "string",
									expand(v) { return normalizeIndexColumn(v); },
									contract(v) { return normalizeIndexColumn(v); },
								}, required: true }
							}
						},
					},
